  ...
  return (
    <div className="bg-card border border-border rounded-2xl p-6 shadow-sm space-y-5">
      ...
      <button
        ...
        className="w-full h-11 flex items-center justify-center gap-3 border border-border rounded-xl text-sm font-medium hover:bg-muted transition-all duration-200"
      >
